...
for var2 = 4
    for var3 = 3
        ...
        for var1=19
            ...
            title(['Two-Neuron Oscillating Network ',sprintf('time offset %gms, pmax %g, taus %g',var1, var2, var3)])
            setfont; axis tight;
...
%             fprintf(sprintf('%g %g %g \n',var1, var2, var3))
            ...
            fprintf(sprintf('%2.2f, mean = %2.2f \n', sum(sqrt((offset-mean(offset)).^2)),mean(offset) ))
